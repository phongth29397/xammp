            ...
            <div class="col-md-8">
                <form action="{{route('updateInformation')}}" method="post" id="fromlogin">
                    <table class="table">
                        ...
                        <tr>
                            <th scope="col" >Thông Tin Của {{$user->full_name}}</th>
                            <th scope="col"  >
                                <div class="row" >
                                    <div class="col-2"></div>
                                    <div class="col-4"><a class="btn btn-dark" href="{{route('showPassword')}}"> Change role</a></div>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" maxlength="32" min="8" name="first_name" class="form-control acc" value="{{ $user->first_name }}">
                                @error('first_name')
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" maxlength="32"  min='8' name="last_name" class="form-control" value="{{ $user->last_name }}">
                                @error('last_name')
                                <div class=" col-6" style="font-size: 12px;color: red">{{ $message }}</div>
                                @enderror
                            </td>
                            ...
                            <td>
                                <div class="row m-0 p-0" name="ss">
                                    <div class=" form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="1" <?php echo ( $user->gender == '1') ?  "checked" : "" ;  ?>>
                                        <label class="form-check-label" for="inlineRadio1">Male</label>
                                    </div>
                                    <div class=" form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="2" <?php echo ( $user->gender == '2') ?  "checked" : "" ;  ?>>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="file"  name="avatar" accept="image/*" class="form-control" value="{{ $user->avatar }}">
                                @error('avatar')
                                <div class=" col-6" style="font-size: 12px;color: red">{{ $message }}</div>
                                @enderror
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control" name="address" id="exampleFormControlTextarea1" rows="3" >{{ $user->address }}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
